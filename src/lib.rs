...
const ONE_NEAR_AS_YOCTO: u128 = 1_000_000_000_000_000_000_000_000; // 1 $NEAR as yoctoNEAR
...
impl Contract {
    ...
    #[init]
    pub fn new(owner_id: ValidAccountId, metadata: NFTContractMetadata, amount: u128) -> Self {
    ...
    pub fn nft_mint(
        ...
        // TODO: receiver_id is always protocol
    ...
    pub fn pay_bounty_hunter(
        ...
        let value = self.value * proportion;
        let yocto: u128 = (value * ONE_NEAR_AS_YOCTO)/100;
